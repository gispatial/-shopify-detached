...
<p>
  By continuing, you acknowledge to accept Delyva credit <a target="_blank" href='https://delyva.com/my/terms'>Terms of Use</a>
        ...
        <PageActions
        primaryAction={{
          disabled: Number(this.state.topupAmount) < 50 || Number(this.state.topupAmount) > 5000 || Number(this.state.perUsd) === 0,
          content: 'Continue',
                ...
                <FormLayout>
                  <Card>
                    <OptionList
                      ...
                      onChange={this.handleChange('selectedServices')}
                      options={this.state.listOfServiceProviders}
